...
router.register(r'activity', StudentActivityViewSet, base_name='activity')
...
router.register(r'manage/settings', SettingsViewSet, base_name='society_bureau_settings')
